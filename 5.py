...
## SI 206 - W17 - HW5
## COMMENT WITH:
## Your section day/time: Thursday 6-7, section 003
## Any names of people you worked with on this assignment:

######## 500 points total ########

## Write code that uses the tweepy library to search for tweets with a 
#phrase of the user's choice (should use the Python input function), 
#and prints out the Tweet text and the created_at value (note that this 
#will be in GMT time) of the first THREE tweets with at least 1 blank 
#line in between each of them, e.g.
...
## You should cache all of the data from this exercise in a file, 
#and submit the cache file along with your assignment. 

## So, for example, if you submit your assignment files, and you have 
#already searched for tweets about "rock climbing", when we run your code, 
#the code should use CACHED data, and should not need to make any new 
#request to the Twitter API. 
## But if, for instance, you have never searched for "bicycles" 
#before you submitted your final files, then if we enter "bicycles" 
#when we run your code, it _should_ make a request to the Twitter API.

## The lecture notes and exercises from this week will be very helpful 
#for this. 
## Because it is dependent on user input, there are no unit tests for 
#this -- we will run your assignments in a batch to grade them!

## We've provided some starter code below, like what is in the class 
#tweepy examples.

## **** For 50 points of extra credit, create another file called 
#twitter_info.py that contains your consumer_key, consumer_secret, 
#access_token, and access_token_secret, import that file here, and 
#use the process we discuss in class to make that information secure! 
...
# information for an 'extra' Twitter account you make just for this class, 
#and not your personal account, because it's not ideal to share your 
#authentication information for a real account that you use frequently.

## Get your secret values to authenticate to Twitter. You may replace 
...
## 3. Invoke your function, save the return value in a variable, and explore 
#the data you got back!
## 4. With what you learn from the data -- e.g. how exactly to find the text 
#of each tweet in the big nested structure -- write code to print out content 
